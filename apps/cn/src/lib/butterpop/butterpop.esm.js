...
const DEFAULT_CONFIG = {
  ...
  autoInject: false, // vendored: butterpop.css is imported locally — never fetch from CDN (works offline)
  animation: {
...
const injectCSS = () => {
  ...
  link.rel = 'stylesheet';
  // China deployment: never reference a CDN, even from this dead code path
  // (autoInject is false and butterpop.css is bundled via the local import).
