...
Phase 4.1 deployed the `cn_demo` schema and reset handler while keeping the application registration disabled. Edge deployment, the named `cn` publishable key, reset activation, Netlify configuration, and DNS remain pending.
